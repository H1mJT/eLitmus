...
PLAYER_INSTRUCTIONS = "eLitmus Assignment by Himjyoti Thakuria.\n\nWord length must be of 5 letters!\nRight Letter at right location = Green color\nRight letter at wrong location = Yellow color\nLetter not present in word = Grey color\nMax guess 6 times\nYou may start guessing\n"
GUESS_STATEMENT = "\nEnter your guess"
ALLOWED_GUESSES = 6
...
def restart():
    restart = input("Would you like to play again?\nType y/yes to accept or type anything else to close the game: ")
...
def game(console, chosen_word):
    ...
    while not end_of_game:
        ...
        if guess == chosen_word or len(already_guessed) == ALLOWED_GUESSES:
            end_of_game = True
    if end_of_game and guess == chosen_word:
        console.print(f'\n[green]Congratulations! You guessed the right word: {chosen_word}[/]')
